...
| 2026-08-09 | Re-verified `scripts/lookalike-check.mjs` live before Adam posts a reply promising it, not trusted from the 2026-08-01 log | last confirmed working 8 days ago, not re-run | still real: beware.dog itself found 14/117 registered (same as 2026-08-01); paypal.com control test found genuinely dangerous live registered domains (paypal-billing.com, paypal-invoice.com, secure-paypal.com, paypal-login.com, others) | live run, this session |
